...
<html>
  ...
  <body>
    <div id='login'>
      ...
      <div class='inner' id="innerDiv">
        <div class='fheader'>&Oacute; reg&iacute;strate aqu&iacute;</div>
        ...
        <div id="create-user" class="content scaffold-create" role="main">
          ...
          <g:form action="save" controller="user" >
            ...
            <div class="fieldcontain ${hasErrors(bean: userInstance, field: 'password', 'error')} required">
              <p>
                ...
                <input type='password' name="password" required="" value="${userInstance?.password}"/>
              </p>
            </div>
